...
public:
	...
	static RebuildGameMovement &Get()
	{
		static RebuildGameMovement r;
	...
	Vector Accelerate(C_BasePlayer * player, Vector & new_vel, Vector & wishdir, float wishspeed, float accel);
